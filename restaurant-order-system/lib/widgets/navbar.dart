...
class Navbar extends StatefulWidget implements PreferredSizeWidget {
  ...
  final bool rightOptionNoti;
  final bool rightOptionCart;
  final List<String> tags;
  final Function getCurrentPage;
  final bool isOnSearch;
  final TextEditingController searchController;
  final Function searchOnChanged;
  final Function searchOnTaped;
  final Function shoppingCartOnTaped;
  ...
  Navbar(
      ...
      this.rightOptionNoti = false,
      this.rightOptionCart = true,
      this.getCurrentPage,
      this.searchController,
      this.isOnSearch = false,
      this.searchOnChanged,
      this.searchOnTaped,
      this.shoppingCartOnTaped,
                  ...
                  children: [
                        ...
                        IconButton(
                            icon: Icon(
                                ...
                                color: !widget.transparent
                                    ? (widget.bgColor == ThemeColors.white
                                        ? ThemeColors.initial
                                        : ThemeColors.white)
                                    : ThemeColors.white,
                                size: 24.0),
                    ...
                    if (widget.rightOptions)
                      Row(
                        ...
                        children: [
                          if(widget.rightOptionNoti) GestureDetector(
                            onTap: () {
                          ...
                          if(widget.rightOptionCart) GestureDetector(
                            onTap: () {
                              if (widget.shoppingCartOnTaped != null) {
                                return widget.shoppingCartOnTaped;
                              }
                              else {
                ...
                if (widget.searchBar)
                  Padding(
                    ...
                    child: Input(
                      ...
                      suffixIcon: Icon(Icons.zoom_in, color: ThemeColors.muted),
                      onTap: widget.searchOnTaped,
                    ),
                  ),
                SizedBox(
                  height: 10.0,
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.camera,
                                color: ThemeColors.initial, size: 22.0),
                            SizedBox(width: 10),
